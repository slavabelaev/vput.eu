                                    ...
                                    <li class="form-renting__form-group-list-item col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <label for="form-renting__type-of-accommodation__apartament"
                                                ...
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <input type="radio"
                                                               ...
                                                               value="1"
                                                               name="data[basic_information][type_of_accommodation]"
                                                               id="form-renting__type-of-accommodation__apartament">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <section class="form-renting__accordion-section">
                    ...
                    <div class="form-renting__accordion-item-collapse form-renting__accordion-item_number_11 collapse"
                        ...
                        <div class="form-renting__accordion-item-content">
                            ...
                            <fieldset class="form-renting__fieldset">
                                <header class="mb-3">
                                    <legend class="form-renting__legend">
                            ...
                            <fieldset class="form-renting__fieldset">
                                <legend class="form-renting__legend">
                                    <div class="d-flex align-items-center">
                                        ИЛИ <a href="#"
                                               data-toggle="collapse"
                                               data-target=".form-renting__profile-collapse"
                                               class="btn btn-outline-primary btn-sm ml-3">ЗАПОЛНИТЕ ВРУЧНУЮ</a>
                                        <span class="text-secondary ml-auto">1 минута</span>
                                    </div>
                                </legend>
                                <div class="form-renting__profile-collapse collapse">
                                    <ul class="form-renting__form-group-list row">
                                        <li class="form-renting__form-group-list-item col-md-6">
                                            <div class="form-group">
                                                <label class="form-renting__form-group-label">Имя <b class="text-danger">*</b></label>
                                                <div class="input-group">
                                                    <input type="text"
                                                           placeholder="Иван"
                                                           class="form-control">
                                        ...
                                        <li class="form-renting__form-group-list-item col-md-6">
                                            <div class="form-group">
                                                <label class="form-renting__form-group-label">Фамилия <b class="text-danger">*</b></label>
                                                <div class="input-group">
                                                    <input type="text"
                                                           placeholder="Иванов"
                                                           class="form-control">
                                        ...
                                        <li class="form-renting__form-group-list-item col-md-6">
                                            <div class="form-group">
                                                <label class="form-renting__form-group-label">Номер телефона *</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            <i class="icon icon__calendar"></i>
                                        ...
                                        <li class="form-renting__form-group-list-item col-md-6">
                                            <div class="form-group">
                                                <label class="form-renting__form-group-label">Дата рождения</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            <i class="icon icon__calendar"></i>
                                        ...
                                        <li class="form-renting__form-group-list-item col-md-12">
                                            <div class="form-group">
                                                <label class="form-renting__form-group-label">Фотография профиля</label>
                                                <input type="file"
                                                       class="filepond"
                                                       name="filepond"
                                                       multiple
