(function () {
    var changeCitiesTabsComponent = function () {
        var blockElement = $('.form-search-offers'), toggleElement = blockElement.find('.form-search-offers__cities-tabs-toggle'), citiesTabsElement = blockElement.find('.form-search-offers__cities-tabs');
