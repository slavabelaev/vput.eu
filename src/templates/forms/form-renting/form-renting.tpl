<div class="form-renting">
    <ol class="accordion">
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse accordion-basic-information collapse"
        ...
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse accordion-prices collapse"
                     data-parent=".accordion">
                    <form action="#" class="accordion-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <button type="submit"
                                                    ...
                                                    data-toggle="collapse"
                                                    data-target=".form-renting__prices-additional-collapse">Сохранить
                                            </button>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="form-renting__prices-additional-collapse collapse">
                            <figure class="alert alert-info" role="alert">
                                <div class="mb-3">Основная цена указывается для всего года. Но также можете
                                    указать индивидуальную цену для любого периода.
                                </div>
                                <a href="#"
        ...
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse form-renting__accordion-item_number_3 collapse"
        ...
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse form-renting__accordion-item_number_4 collapse"
                     aria-labelledby="headingThree"
                     data-parent=".accordion">
                    <form action="#" class="accordion-content">
                        <fieldset class="form-renting__fieldset">
                                ...
                                <li class="form-renting__form-group-list-item col">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="form-renting__information-about-accommodation__anytime">В любое
                                                время</label>
                                        </div>
                                    </div>
                                </li>
        ...
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse form-renting__accordion-item_number_5 collapse"
                     data-parent=".accordion">
                    <form action="#" class="accordion-content">
                        <fieldset class="form-renting__fieldset">
                            <ul class="form-renting__form-group-list row">
        ...
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse form-renting__accordion-item_number_6 collapse"
                     aria-labelledby="headingThree"
                     data-parent=".accordion">
                            ...
                            <div class="row">
                                <div class="col-xl-5 col-sm-6">
                                    <ul class="form-renting__form-group-list row">
                                        ...
                                        <li class="form-renting__form-group-list-item col">
                                            <div class="form-group">
                                                <label class="form-renting__form-group-label">Заказать смену
                                                    белья</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                        ...
                                        <li class="form-renting__form-group-list-item col">
                                            <div class="form-group">
                                                <label class="form-renting__form-group-label">Гарантийный
                                                    депозит</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                ...
                                <div class="col-xl-5 col-sm-6 offset-xl-1">
                                    <ul class="form-renting__form-group-list row">
                                        <li class="form-renting__form-group-list-item col">
                                            <div class="form-group">
                                                <label class="form-renting__form-group-label">Автобусная
                                                    остановка</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
        ...
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse form-renting__accordion-item_number_7 collapse"
                     data-parent=".accordion">
                    <form action="#" class="accordion-content">
                        <fieldset class="form-renting__fieldset">
                            <ul class="form-renting__form-group-list row">
                                ...
                                <li class="form-renting__form-group-list-item col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="form-renting__facilities__has-swimming-pool">Внутренний
                                                бассейн</label>
                                        </div>
                                    </div>
                                </li>
                                <li class="form-renting__form-group-list-item col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="form-renting__facilities__has-medical-office">Медицинский
                                                кабинет</label>
                                        </div>
                                    </div>
                                </li>
                                <li class="form-renting__form-group-list-item col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="form-renting__facilities__has-shower-cabin">Душевая
                                                кабина</label>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="form-renting__form-group-list-item col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="form-renting__facilities__has-playground">Детская
                                                площадка</label>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="form-renting__form-group-list-item col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="form-renting__facilities__has-microwave">Микроволновая
                                                печь</label>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="form-renting__form-group-list-item col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="form-renting__facilities__has-game-console">Игровая
                                                приставка</label>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="form-renting__form-group-list-item col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="form-renting__facilities__has-dishwasher">Посудомоечная
                                                машина</label>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="form-renting__form-group-list-item col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label"
                                                   for="form-renting__facilities__has-ironing-board">Гладильная
                                                доска</label>
                                        </div>
                                    </div>
                                </li>
        ...
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse form-renting__accordion-item_number_8 collapse"
                     aria-labelledby="headingThree"
                     data-parent=".accordion">
                    <form action="#" class="accordion-content">
                        <fieldset class="form-renting__fieldset">
        ...
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse form-renting__accordion-item_number_9 collapse"
                     data-parent=".accordion">
        ...
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse form-renting__accordion-item_number_10 collapse"
                     aria-labelledby="headingThree"
                     data-parent=".accordion">
                    <div class="accordion-content">
                        <fieldset class="form-renting__fieldset">
        ...
        <li class="accordion-item">
            <section class="accordion-section">
                ...
                <div class="accordion-item-collapse form-renting__accordion-item_number_11 collapse"
                     aria-labelledby="headingThree"
                     data-parent=".accordion">
                    <div class="accordion-content">
    ...
    <div class="text-center">
        <div class="form-renting__text-of-agreement mb-4">Размещая объявление на нашем сайте, вы соглашаетесь с <a
                    href="booking-cancelation-rules-ru.html" target="_blank">правилами отмены бронирования</a>, а также
            подтверждаете, что принимаете условия <a href="owner-agreement-ru.html" target="_blank">пользовательского
                соглашения с Арендодателем</a></div>
