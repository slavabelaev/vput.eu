...
<article class="article-user-agreement container py-5 mw-1024px">
    <h1 class="mb-4">Owner Agreement</h1>

    <section>
        <h2>V.P.U.T. IS A VIRTUAL PLATFORM FOR PLACING ADS FROM PROPERTY OWNERS ALL OVER THE WORLD.</h2>
        <ul>
            <li>it is a free online account, a ready-made mini-business for renting property with an option to monitor and manage your ads and bookings;</li>
            <li>it is a modern booking system for travellers with an ability to communicate directly with owners around the world.</li>
        </ul>
    ...
    <section>
        ...
        <p>
            By registering on the website, the User agrees with the terms of this Agreement. <strong>Please do not use V.P.U.T. service, do not register or place an ad on the website, if you do not agree with the terms of this Agreement</strong>. The Company reserves the right to amend the Agreement (including the commission fee), at its sole discretion, without prior notice at any time, and the changes are considered valid from the date of publication on the website.
        </p>
        <p>
    ...
    <section>
        ...
        <ul>
            ...
            <li>the profile of the Landlord contains invalid, inaccurate information, for example, a non-existent e-mail address;</li>
            <li>the Landlord has transferred his account to a third party;</li>
            <li>there have been found other compelling reasons for blocking the User that must be done to avoid the risks or violations of the interests of the Company or other Users.</li>
        </ul>
        <p>
    ...
    <section>
        ...
        <ul>
            ...
            <li>will not intentionally or unintentionally violate any applicable local, state, national or international laws;</li>
            <li>will not register an account on behalf of another person (fake account), or act on behalf of an individual or legal entity whose interests he is not authorized to represent; </li>
            <li>will not post his phone numbers and e-mail addresses or other personal details during message communication before payment of booking;</li>
        ...
        <ul>
            ...
            <li>archiving of the materials in order to include them in databases, copying and storage of materials on any information carriers and data storage devices, integration with other informational materials;</li>
            <li>demonstration and reproduction in any form, transfer of materials in any desired manner using any carriers and their distribution via existing media;</li>
            <li>modification and processing, reduction, addition and change of the source materials; conversion of data for the use in mobile devices;</li>
    ...
    <section>
        ...
        <p>
            The Renter who received a confirmed booking from the Landlord is obliged to pay it within 24 hours from the time of booking confirmation. Unpaid within the specified time, the reservation will be cancelled.
        </p>
        <p>
            The total rental cost pre-arranged by the Users is final. The Landlord has no right to increase the price for accommodation after the payment of the reservation.
        </p>
        <p>
        ...
        <p>
            After the conclusion of the rental agreement between the parties and provided that within 24 hours after the Renter has arrived he has no objective claims regarding the accommodation, V.P.U.T. sends the money received from the Renter (minus the commission fee) to the account of the Landlord from where he can request a withdrawal by bank transfer.
        </p>
        <p>
            Charges for V.P.U.T. services are 9%—12% of final cost of the booking.
        </p>
        <p>Company V.P.U.T. pays the due amounts to the Landlord on behalf of the Renter; the Company shall not be a party to a contract between them. Company V.P.U.T. is not responsible for any consequences regarding the declaration and payment of taxes on behalf of the Landlord on the territory of the Republic of Bulgaria.
        </p>
        <p>
            V.P.U.T. reserves the right to change the commission rate at the cost of price increase/decrease without any changes in estimated earnings of the Owner. Terms for the already made bookings remain unchanged.
        </p>
    ...
    <section>
        <h2>Requisite details of LLC "VPUT"</h2>
        <ul>
            <li>Legal address: Sunny Beach Plaza Business-centre office 2, 3, Sunny Beach 8240, Nesebar, Nesebar Municipality, Burgas Province, Bulgaria</li>
            <li>Business address: Sunny Beach Plaza Business-centre office 2, 3, Sunny Beach 8240, Nesebar, Nesebar Municipality, Burgas Province, Bulgaria</li>
            <li>Postal address: Sunny Beach Plaza Business-centre office 2, 3, Sunny Beach 8240, Nesebar, Nesebar Municipality, Burgas Province, Bulgaria</li>
