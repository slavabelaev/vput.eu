<div class="row">
    <div class="col-lg-7">
        ...
        <ol class="renting-form__accordion">
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-basic-information"
                        aria-expanded="false">1. Основная информация</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-basic-information collapse"
                         data-parent=".accordion">
                        <form action="#" class="renting-form__accordion-item-content">

                            <fieldset class="renting-form__fieldset">
                                <ul class="renting-form__form-group-list row">
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Тип жилья</label>
                                            <div class="input-group">
                                                ...
                                                <label for="renting-form__type-of-accommodation__house"
                                                ...
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <input type="radio"
                                                               ...
                                                               id="renting-form__type-of-accommodation__house">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label d-none d-sm-block">&nbsp;</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                ...
                                                <label for="renting-form__type-of-accommodation__apartament"
                                                ...
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <input type="radio"
                                                               ...
                                                               value="1"
                                                               name="data[basic_information][type_of_accommodation]"
                                                               id="renting-form__type-of-accommodation__apartament">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Кол-во комнат</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Вмещает гостей</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Мин. срок
                                                аренды</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
            ...
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-prices"
                        aria-expanded="false">2. Цены</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-prices collapse"
                         data-parent=".accordion">
                        <form action="#" class="renting-form__accordion-item-content">
                            ...
                            <fieldset class="renting-form__fieldset">
                                <ul class="renting-form__form-group-list row">
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Цена за ночь</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Вы получите</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">€</div>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <button type="submit"
                                                        ...
                                                        data-toggle="collapse"
                                                        data-target=".renting-form__prices-additional-collapse">Сохранить</button>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="renting-form__prices-additional-collapse collapse">
                                ...
                                <fieldset class="renting-form__additional-prices collapse">
                                    <legend class="renting-form__legend">Дополнительные цены</legend>
                                    <div class="row">
                                        <div class="form-group col">
                                            <label class="renting-form__form-group-label">Начало периода</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <i class="icon icon__calendar"></i>
                                        ...
                                        <div class="form-group col">
                                            <label class="renting-form__form-group-label">Конец периода</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <i class="icon icon__calendar"></i>
                                ...
                                <fieldset class="renting-form__fieldset">
                                    <legend class="renting-form__legend">Скидки</legend>
                                    <div class="row">
                                        <div class="form-group col">
                                            <label class="renting-form__form-group-label">Понедельная
                                        ...
                                        <div class="form-group col">
                                            <label class="renting-form__form-group-label">Помесячная
                                                <i class="icon icon__information ml-2"
                                                   data-toggle="tooltip"
                                                   data-placement="right"
                                                   data-html="true"
                                ...
                                <fieldset class="renting-form__fieldset">
                                    <legend class="renting-form__legend">Дополнительные опции</legend>
                                    <div class="row">
                                        <div class="form-group col">
                                            <label class="renting-form__form-group-label">Плата за финальную уборку</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">€</div>
                                                </div>
                                        ...
                                        <div class="form-group col">
                                            <label class="renting-form__form-group-label">Предоплата
                                                <i class="icon icon__information ml-2"
                                                   data-toggle="tooltip"
                                                   data-placement="right"
                                                   data-html="true"
                                        ...
                                        <div class="form-group col">
                                            <label class="renting-form__form-group-label">Невозвратный депозит
                                                <i class="icon icon__information ml-2"
                                                   data-toggle="tooltip"
                                                   data-placement="right"
                                                   data-html="true"
            ...
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-item_number_3"
                        aria-expanded="false"
                        aria-controls="collapseThree">3. Спальные места</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-item_number_3 collapse"
                        ...
                        <form action="#" class="renting-form__accordion-item-content">
                            <ul class="renting-form__form-group-list row">
                                <li class="renting-form__form-group-list-item col">
                                    <div class="form-group">
                                        <label class="renting-form__form-group-label">Двуспальная
                                            раздвижная</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                ...
                                <li class="renting-form__form-group-list-item col">
                                    <div class="form-group">
                                        <label class="renting-form__form-group-label">Кресло раскладное</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                ...
                                <li class="renting-form__form-group-list-item col">
                                    <div class="form-group">
                                        <label class="renting-form__form-group-label">Детская кроватка</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                ...
                                <li class="renting-form__form-group-list-item col">
                                    <div class="form-group">
                                        <label class="renting-form__form-group-label">Диван раскладной</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                ...
                                <li class="renting-form__form-group-list-item col">
                                    <div class="form-group">
                                        <label class="renting-form__form-group-label">Односпальная
                                            кровать</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
            ...
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-item_number_4"
                        aria-expanded="false"
                        aria-controls="collapseThree">4. Информация о жилье</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-item_number_4 collapse"
                         aria-labelledby="headingThree"
                         data-parent=".accordion">
                        <form action="#" class="renting-form__accordion-item-content">
                            <fieldset class="renting-form__fieldset">
                                <legend class="renting-form__legend">Правила заселения и выселения</legend>
                                <ul class="renting-form__form-group-list row">
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Заселение</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Выселение</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">&nbsp;</label>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       name="data[information_about_accommodation][anytime]"
                                                       class="custom-control-input"
                                                       id="renting-form__information-about-accommodation__anytime">
                                                <label class="custom-control-label"
                                                       for="renting-form__information-about-accommodation__anytime">В любое время</label>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <fieldset class="renting-form__fieldset">
                                <legend class="renting-form__legend">Доплата за дополнительного гостя</legend>
                                <ul class="renting-form__form-group-list row">
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <label for="renting-form__supplement-for-extra-guest__you-can-not"
                                                ...
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <input type="radio"
                                                               ...
                                                               id="renting-form__supplement-for-extra-guest__you-can-not">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <label for="renting-form__supplement-for-extra-guest__is-free"
                                                ...
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <input type="radio"
                                                               value="0"
                                                               name="data[information_about_accommodation][rules_for_settling_and_eviction][supplement_for_extra_guest]"
                                                               id="renting-form__supplement-for-extra-guest__is-free">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <fieldset class="renting-form__fieldset">
                                <legend class="renting-form__legend">Правила отмены бронирования</legend>
                                <ul class="renting-form__form-group-list row">
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <div class="input-group">
                            ...
                            <figure class="alert alert-info">
                                ...
                                финансовой компенсацией, будут разрешаться согласно <a
                                        href="/booking_cancelation_rules/" target="_blank">выбранному варианту
            ...
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-item_number_5"
                        aria-expanded="false">5. Правила дома</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-item_number_5 collapse"
                         data-parent=".accordion">
                        <form action="#" class="renting-form__accordion-item-content">
                            <fieldset class="renting-form__fieldset">
                                <ul class="renting-form__form-group-list row">
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">С детьми</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Курить</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Питомцы</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Условия для инвалидов</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
            ...
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-item_number_6"
                        aria-expanded="false"
                        aria-controls="collapseThree">6. Описание</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-item_number_6 collapse"
                         aria-labelledby="headingThree"
                         data-parent=".accordion">
                        <form class="renting-form__accordion-item-content">
                            <fieldset class="renting-form__fieldset">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text"
                            ...
                            <fieldset class="renting-form__fieldset">
                                <legend class="renting-form__legend">Дополнительная информация</legend>
                                ...
                                <div class="row">
                                    <div class="col-5">
                                        <ul class="renting-form__form-group-list row">
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Балкон</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Вид с окон</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Этажность</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Лифт</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Ванные комнаты</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Уборка</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Заказать уборку</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Смена белья</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Заказать смену белья</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Гарантийный депозит</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Завтрак</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Интернет</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Парковка</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                    ...
                                    <div class="col-5">
                                        <ul class="renting-form__form-group-list row">
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Автобусная остановка</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                                        ...
                                                        <select name="data[additional_information][distance_to][bus_stop][unit]"
                                                                class="renting-form__size-select custom-select">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Ресторан</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Пляж</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Подъемник</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Аэропорт</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Банкомат</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Центр города</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                            ...
                                            <li class="renting-form__form-group-list-item col">
                                                <div class="form-group">
                                                    <label class="renting-form__form-group-label">Индивидуальный ID</label>
                                                    <div class="input-group">
                                                        <input type="number"
                                                               value="0"
                                                               min="0"
            ...
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-item_number_7"
                        aria-expanded="false">7. Удобства</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-item_number_7 collapse"
                         data-parent=".accordion">
                        <form action="#" class="renting-form__accordion-item-content">
                            <fieldset class="renting-form__fieldset">
                                <ul class="renting-form__form-group-list row">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-parking">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-parking">Парковка</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-pool">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-pool">Бассейн</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-spa">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-spa">СПА</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-recipe">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-recipe">Рецепция</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-swimming-pool">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-swimming-pool">Внутренний бассейн</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-medical-office">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-medical-office">Медицинский кабинет</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-shower-cabin">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-shower-cabin">Душевая кабина</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-security">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-security">Охрана</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-jacuzzi">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-jacuzzi">Джакузи</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-barbershop">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-barbershop">Парикмахерская</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-bath">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-bath">Ванна</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-playground">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-playground">Детская площадка</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-sauna">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-sauna">Сауна</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-pool-bar">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-pool-bar">Пул-бар</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-laundry">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-laundry">Прачечная</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-garden">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-garden">Сад</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-fitness">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-fitness">Фитнес</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-lobby-bar">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-lobby-bar">Лобби-бар</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-barbecue">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-barbecue">Барбекю</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-restaurant">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-restaurant">Ресторан</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-cable-tv">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-cable-tv">Кабельное ТВ</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-air-conditioner">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-air-conditioner">Кондиционер</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-gas-stove">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-gas-stove">Плита</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-refrigerator">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-refrigerator">Холодильник</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-tv">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-tv">Телевизор</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-fireplace">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-fireplace">Камин</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-microwave">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-microwave">Микроволновая печь</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-washer">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-washer">Стиральная машина</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-safe">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-safe">Сейф</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-kettle">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-kettle">Чайник</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-dryer">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-dryer">Сушилка</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-game-console">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-game-console">Игровая приставка</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-juicer">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-juicer">Соковыжималка</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-dishwasher">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-dishwasher">Посудомоечная машина</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-iron">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-iron">Утюг</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-toaster">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-toaster">Тостер</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-oven">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-oven">Духовка</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-ironing-board">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-ironing-board">Гладильная доска</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-blender">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-blender">Блендер</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-coffee-maker">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-coffee-maker">Кофеварка</label>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="renting-form__form-group-list-item col-md-6">
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox"
                                                       ...
                                                       class="custom-control-input"
                                                       id="renting-form__facilities__has-hairdryer">
                                                <label class="custom-control-label"
                                                       for="renting-form__facilities__has-hairdryer">Фен</label>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
            ...
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-item_number_8"
                        aria-expanded="false"
                        aria-controls="collapseThree">8. Адрес</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-item_number_8 collapse"
                         aria-labelledby="headingThree"
                         data-parent=".accordion">
                        <form action="#" class="renting-form__accordion-item-content">
                            <fieldset class="renting-form__fieldset">
                                <ul class="renting-form__form-group-list row">
                                    <li class="renting-form__form-group-list-item col-md-4">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Город</label>
                                            <div class="input-group">
                                                <input type="text"
                                    ...
                                    <li class="renting-form__form-group-list-item col-md-4">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Улица</label>
                                            <div class="input-group">
                                                <input type="text"
                                    ...
                                    <li class="renting-form__form-group-list-item col-md-3">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Номер дома</label>
                                            <div class="input-group">
                                                <input type="text"
            ...
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-item_number_9"
                        aria-expanded="false">9. Фотографии</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-item_number_9 collapse"
                         data-parent=".accordion">
                        <div class="renting-form__accordion-item-content">
                            <fieldset class="renting-form__fieldset">
                                <input type="file"
                                       class="filepond"
                                       name="data[photos]"
            ...
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-item_number_10"
                        aria-expanded="false"
                        aria-controls="collapseThree">10. Календарь</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-item_number_10 collapse"
                         aria-labelledby="headingThree"
                         data-parent=".accordion">
                        <div class="renting-form__accordion-item-content">
                            <fieldset class="renting-form__fieldset">
                                <legend class="renting-form__legend">Когда ваше жилье будет свободно?</legend>
                                <ul class="renting-form__form-group-list row">
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Начало периoда</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <i class="icon icon__calendar"></i>
                                    ...
                                    <li class="renting-form__form-group-list-item col">
                                        <div class="form-group">
                                            <label class="renting-form__form-group-label">Конец периoда</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <i class="icon icon__calendar"></i>
            ...
            <li class="renting-form__accordion-item">
                <section class="renting-form__accordion-section">
                    <h3 class="renting-form__accordion-section-title collapsed"
                        data-toggle="collapse"
                        data-target=".renting-form__accordion-item_number_11"
                        aria-expanded="false"
                        aria-controls="collapseThree">11. Информация о себе</h3>
                    <div class="renting-form__accordion-item-collapse renting-form__accordion-item_number_11 collapse"
                         aria-labelledby="headingThree"
                         data-parent=".accordion">
                        <div class="renting-form__accordion-item-content">
                            ...
                            <fieldset class="renting-form__fieldset">
                                <header class="mb-3">
                                    <legend class="renting-form__legend">
                                        <div class="d-flex align-items-center">ЗАПОЛНИТЕ ОДНИМ КЛИКОМ <span
                                                    class="text-secondary ml-auto">1 секунда</span></div>
                                    </legend>
                            ...
                            <fieldset class="renting-form__fieldset">
                                ...
                                <div class="renting-form__profile-collapse collapse">
                                    <ul class="renting-form__form-group-list row">
                                        <li class="renting-form__form-group-list-item col-md-6">
                                            <div class="form-group">
                                                <label class="renting-form__form-group-label">Имя <b class="text-danger">*</b></label>
                                                <div class="input-group">
                                                    <input type="text"
                                                           placeholder="Иван"
                                                           class="form-control">
                                        ...
                                        <li class="renting-form__form-group-list-item col-md-6">
                                            <div class="form-group">
                                                <label class="renting-form__form-group-label">Фамилия <b class="text-danger">*</b></label>
                                                <div class="input-group">
                                                    <input type="text"
                                                           placeholder="Иванов"
                                                           class="form-control">
                                        ...
                                        <li class="renting-form__form-group-list-item col-md-6">
                                            <div class="form-group">
                                                <label class="renting-form__form-group-label">Номер телефона *</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            <i class="icon icon__calendar"></i>
                                        ...
                                        <li class="renting-form__form-group-list-item col-md-6">
                                            <div class="form-group">
                                                <label class="renting-form__form-group-label">Дата рождения</label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            <i class="icon icon__calendar"></i>
                                        ...
                                        <li class="renting-form__form-group-list-item col-md-12">
                                            <div class="form-group">
                                                <label class="renting-form__form-group-label">Фотография профиля</label>
                                                <input type="file"
                                                       class="filepond"
                                                       name="filepond"
                                                       multiple
        ...
        <div class="text-center">
            <div class="renting-form__text-of-agreement mb-4">Размещая объявление на нашем сайте, вы соглашаетесь с <a href="/booking_cancelation_rules/" target="_blank">правилами отмены бронирования</a>, а также подтверждаете, что принимаете условия <a href="/owner_agreement/" target="_blank">пользовательского соглашения с Арендодателем</a></div>
