<% var lang = JSON.parse(include('page-index_lang_ru.json')); %>
...
<!-- Page: page-index -->
<link rel="stylesheet" href="assets/pages/site/page-index.css">
<script src="assets/pages/site/page-index.js" defer></script>
