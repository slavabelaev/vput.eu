(function() {
    let blockElement = document.querySelector('.page-offer');

    if (!blockElement) return false;

    function convertAsideToDrawerWindow() {
        let modalElement = $('.page-offer__modal'),
            modalDialogElement = $('.page-offer__modal-dialog'),
            asideElement = $('.page-offer__aside');
